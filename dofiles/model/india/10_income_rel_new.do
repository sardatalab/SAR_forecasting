...
/*===================================================================================================
	4 - RESCALING GROWTH TO MATCH SECTORAL MACRO GDP RATES
===================================================================================================*/
...
forvalues i = 1/`lim' {
	sum lai_m	[aw = weight] if lai_m > 0 & lai_m < . & sect_main    == `i'
...
* Difference between sectoral micro and macro growth data
...
* Expands income labor by sector
forvalues c = 1/`lim'	{
   replace lai_m_s = lai_m_s * (1 + growth_ila_macro_n[`c',1]) if lai_m_s > 0 & lai_m_s != . & sect_main_s == `c'
   replace lai_s_s = lai_s_s * (1 + growth_ila_macro_n[`c',1]) if lai_s_s > 0 & lai_s_s != . & sect_secu   == `c' 
}
...
/*===================================================================================================
	5 - RESCALING GROWTH TO MATCH TOTAL GDP RATE
===================================================================================================*/
