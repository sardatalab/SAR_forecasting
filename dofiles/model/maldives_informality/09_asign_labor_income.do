...
if $m == 1 {
	...
	* Those who remain in their sector but changes their intrasectoral status   
	mat score predila_n = b_1 if occupation == 2 & occupation_s == 2 & sample == 1 & formal_s == 1 & formal == 0, replace
	mat score predila_n = b_2 if occupation == 3 & occupation_s == 3 & sample == 1 & formal_s == 1 & formal == 0, replace
	mat score predila_n = b_3 if occupation == 4 & occupation_s == 4 & sample == 1 & formal_s == 1 & formal == 0, replace

	mat score predila_n = b_1 if occupation == 2 & occupation_s == 2 & sample == 1 & formal_s == 0 & formal == 1, replace
	mat score predila_n = b_2 if occupation == 3 & occupation_s == 3 & sample == 1 & formal_s == 0 & formal == 1, replace
	mat score predila_n = b_3 if occupation == 4 & occupation_s == 4 & sample == 1 & formal_s == 0 & formal == 1, replace
	...
	* Those who mantain their employment, sectoral, and intrasectoral status
	gen     lai_m_s = .
	replace lai_m_s = lai_m if occupation == occupation_s & inrange(occupation_s,2,4) & formal == formal_s & lai_m != .        
...
if $m != 1 {
	...
	* Those who come from FORMAL - AGRICULTURE
	...
	* Those who come from INFORMAL - AGRICULTURE
	mat score predila_n  = b_1 if occupation == 3 & occupation_s == 2 & sample == 1, replace
	...
	* Those who come from FORMAL - INDUSTRY
	mat score predila_n  = b_1 if occupation == 4 & occupation_s == 2 & sample == 1, replace
	...
	* Those who come from INFORMAL - INDUSTRY
	...
	* Those who come from FORMAL - SERVICES
	...
	* Those who come from INFORMAL - SERVICES
	...
	* Those who mantain their employment, sectoral, and intrasectoral status
	gen     lai_m_s = .
	replace lai_m_s = lai_m if occupation == occupation_s & inrange(occupation_s,2,7) & formal == formal_s & lai_m != . 
